...
const features: { icon: LucideIcon; title: string; description: string; color: string, variant: 'primary' | 'success' | 'secondary', details: string[] }[] = [
    {
        icon: Globe,
        ...
        <section className="py-20 px-6 bg-nexus-dark">
            <div className="container mx-auto max-w-6xl">
                <div className="text-center mb-12">
                    ...
                    <p className="text-nexus-text-muted font-matrix">Experience the infinite possibilities of future technology</p>
                </div>
                        ...
                        <CyberFrame key={index} color={feature.color} corners>
                            <div className="p-6 h-full flex flex-col text-center space-y-4">
                                <div className="relative w-16 h-16 mx-auto flex items-center justify-center">
                                    ...
                                    <div className="absolute inset-0 animate-ping rounded-full" style={{ backgroundColor: feature.color, opacity: 0.2 }} />
                                </div>
                                ...
                                <div className="space-y-2 pt-4 border-t" style={{ borderColor: `${feature.color}20`}}>
                                    {feature.details.map(detail => (
                                        <p key={detail} className="text-xs font-matrix text-nexus-text-muted">{detail}</p>
                                    ))}
                                </div>
