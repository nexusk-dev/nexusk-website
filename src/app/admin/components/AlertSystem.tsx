            ...
            <GlassCard hover={false}>
                <div className="space-y-4">
                    {alerts.map(alert => {
                        ...
                        return (
                            <div key={alert.id} className={`bg-nexus-darker/50 rounded-lg p-4 border-l-4 flex items-center justify-between ${config.className} ${alert.acknowledged ? 'opacity-60' : ''}`}>
