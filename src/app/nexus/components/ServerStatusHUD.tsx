...
import { Users, Activity, Clock, Zap, Cpu, HardDrive } from 'lucide-react';
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                    <div>
                        ...
                        <div className="text-2xl font-cyber text-nexus-primary">{serverData.players.current}/{serverData.players.max}</div>
                ...
                <div className="space-y-4 pt-4 border-t border-nexus-primary/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <CyberProgress label="DISK" value={(serverData.disk.used / serverData.disk.total) * 100} variant="warning" />
                    </div>
                </div>
            </div>
        </CyberFrame>
