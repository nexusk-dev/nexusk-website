    ...
    return (
        <GlassCard hover={false} className="space-y-6">
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto p-1">
                {players.map((player) => (
                    <div key={player.id}
                         className="bg-nexus-darker/50 rounded-lg p-3 hover:bg-nexus-surface transition-colors flex items-center justify-between gap-4">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span
                                        className={`text-xs px-2 py-0.5 rounded font-matrix font-bold ${rankConfig[player.rank].className}`}>
                    {player.rank}
                  </span>
                                </div>
