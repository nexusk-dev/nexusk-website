    ...
    const mods = [
        {
            ...
            description: 'Advanced storage and automation'
        },
        {
            name: 'Thermal Expansion',
            version: '10.0.4',
            category: 'Tech' as const,
            description: 'Machines and energy systems'
        },
        {
            name: 'Tinkers Construct',
            version: '3.7.1',
            category: 'Tools' as const,
            description: 'Customizable tools and weapons'
        },
        {
            name: 'Biomes O Plenty',
            version: '18.0.2',
            category: 'World' as const,
            description: 'Additional biomes and blocks'
        },
    ...
    return (
        <GlassCard hover={false} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {mods.map((mod) => (
                    <div key={mod.name}
                         className="bg-nexus-darker/50 rounded-lg p-4 hover:bg-nexus-surface transition-colors">
                        <div className="flex items-start justify-between mb-2">
                            ...
                            <span
                                className={`text-xs px-2 py-1 rounded font-matrix ${categoryConfig[mod.category].className}`}>
                {mod.category}
              </span>
                        </div>
