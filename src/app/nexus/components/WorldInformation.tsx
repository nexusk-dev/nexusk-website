        ...
        <GlassCard hover={false} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                    <h4 className="text-lg font-cyber text-nexus-accent border-b border-nexus-accent/20 pb-2">BASIC INFO</h4>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {worldData.biomes.map((biome) => (
                                    <span key={biome} className="bg-nexus-primary/10 text-nexus-primary text-xs font-matrix px-2 py-1 rounded">{biome}</span>
                                ))}
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {worldData.structures.map((structure) => (
                                    <span key={structure} className="bg-nexus-electric-purple/10 text-nexus-electric-purple text-xs font-matrix px-2 py-1 rounded">{structure}</span>
                                ))}
                            </div>
                        </div>
                    </div>
